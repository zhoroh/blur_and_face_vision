...
# Setting page layout
st.set_page_config(
    page_title="Object Detection and Segmentation using YOLOv8",
    page_icon="🤖",
    layout="wide",
        ...
        if source_img is None:
            ...
            if selected_options:
                ...
                if st.sidebar.button('Detect Objects'):
                    ...
                    res =model.predict(uploaded_image,conf=confidence,classes=classes_to_detect)
                    boxes = res[0].boxes
...
# elif source_radio == settings.UPLOAD_VIDEO:
